...
export const THEMES = {
  spring: {
    ...
    text: BRAND.navy, textSec: "#556678",
...
// 夜間深色底盤（睡前情境）—— 保留該季主色，僅換暗背景與亮字
const NIGHT = {
  bg: "#12151C", card: "#1B2130",
  text: "#E7ECF5", textSec: "#93A0B6",
  subLight: "#22322A",
  gradient: "linear-gradient(135deg, #1C2333 0%, #141924 100%)",
  headerBg: "linear-gradient(180deg, #1C2740 0%, #12151C 100%)",
};
const DARK_ACCENT = { spring: "#8FBBA3", summer: "#8FB2E4", autumn: "#ACA4E6", winter: "#93A9CE" };

// 依季節與深/淺產生主題物件
export function makeTheme(seasonKey, dark) {
  const s = THEMES[seasonKey] || THEMES.summer;
  if (!dark) return s;
  return {
    ...s, ...NIGHT,
    accent: DARK_ACCENT[seasonKey] || DARK_ACCENT.summer,
    accentLight: "#232C40",
    sub: BRAND.sage,
    dark: true, key: s.key + "-dark",
  };
}
